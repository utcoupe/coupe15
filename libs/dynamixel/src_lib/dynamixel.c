...
EXPORT int dxl_initialize( int devIndex, int baudnum )
{
	float baudrate;	
...
EXPORT int dxl_read_byte( int id, int address )
{
	while(giBusUsing);
...
EXPORT void dxl_write_byte( int id, int address, int value )
{
	while(giBusUsing);
...
EXPORT void dxl_write_word( int id, int address, int value )
{
	while(giBusUsing);
